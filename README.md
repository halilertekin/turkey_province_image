...
**The most comprehensive address data package for Turkey!** 81 provinces, 973 districts, 32,000+ neighborhoods, and 245+ streets. **With TypeScript support!**
...
// Output: İSTANBUL: 39 districts, 960 neighborhoods
```
...
### v3.3.1 (2026-05-23) 🛠️
- 🐛 **Sync Fix** - Streets data synced with new official district/neighborhood codes.
- 📚 **Docs Update** - Stats and links updated.
